        ...
        <div className="bg-[linear-gradient(to_bottom,#000000_0%,#80808094_18%,#FFFFFF_100%)] p-6 sm:p-10 rounded-3xl shadow-sm w-full max-w-md box-border">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-12 py-3.5 bg-white border border-slate-200 rounded-2xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-500 transition duration-200 disabled:opacity-60"
                            />
                    ...
                    <button
                        ...
                        disabled={isSubmitting}
                        className="w-full py-4 bg-white border border-slate-200 text-slate-800 font-semibold rounded-2xl hover:bg-slate-50 transition duration-200 flex items-center justify-center gap-2"
                    >
